            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <asp:Button class="btn btn-block btn-primary" ID="Button2" runat="server" Text="Issue" />
                            </div>
                            <div class="col-6">
                                <asp:Button class="btn btn-block btn-success" ID="Button3" runat="server" Text="Return" />
                            </div>
