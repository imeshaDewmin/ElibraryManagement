                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Member ID"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="Postal Code" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Full Postal Address" TextMode="MultiLine" ReadOnly="True"></asp:TextBox><br />
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-8 mx-auto">
                                <asp:Button class="btn btn-block btn-danger" ID="Button2" runat="server" Text="Delete User Permanently" />
                            </div>
                        </div>
